        ...
        <Link href="/" className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-slate-400">
              Business Documents for UAE & Saudi Arabia
            </div>
          </div>
        </Link>
...
const values = [
  {
    icon: Shield,
    title: "Built for GCC VAT Requirements",
    text: "Professional invoices and quotations designed for businesses in the UAE, Saudi Arabia, and GCC markets with VAT-ready workflows.",
  },
  {
    icon: Zap,
    title: "Speed First",
    text: "We built DOCUVAT because creating professional business documents should take seconds, not hours.",
  },
  {
    icon: Heart,
    title: "Built for Growing Businesses",
    text: "Freelancers, consultants, agencies, and trading companies across the UAE and Saudi Arabia use DOCUVAT to simplify daily operations.",
  },
  {
    icon: Globe,
    title: "Arabic & English Ready",
    text: "Designed for Arabic and English business environments across the Gulf region with clean, professional document layouts.",
  },
];

const stats = [
  { value: "3", label: "Document Types" },
  { value: "9", label: "Design Themes" },
  { value: "GCC", label: "Business Ready" },
      ...
      <div className="relative z-10">
        ...
        <main className="mx-auto max-w-7xl px-6 py-20">
          ...
          >
            ...
            <p className="text-xl text-slate-300 leading-relaxed max-w-3xl mx-auto">
              DOCUVAT helps businesses across the UAE, Saudi Arabia, and the GCC
              create professional invoices, quotations, and purchase orders in
              seconds. Modern, bilingual, VAT-ready, and built for growing companies.
            </p>
          </motion.div>
          ...
          >
            <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-10">
              ...
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <p>
                  We started DOCUVAT after seeing how much time businesses across
                  the Gulf waste creating invoices, quotations, and client documents
                  manually. Small businesses needed something simpler, faster,
                  and more professional.
                </p>

                <p>
                  DOCUVAT was designed to help modern companies generate polished
                  business documents instantly — without complicated accounting software
                  or outdated templates.
                </p>

                <p>
                  Whether you run a consulting company in Dubai, a trading business
                  in Riyadh, or a freelance agency anywhere in the GCC, DOCUVAT
                  gives you a faster and more professional workflow.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-400 mb-8 max-w-2xl mx-auto">
              Create invoices, quotations, and purchase orders in minutes with
              DOCUVAT. Designed for businesses across the UAE, Saudi Arabia,
              and the GCC region.
            </p>
            ...
            <div className="mt-8 pt-8 border-t border-white/10 flex items-center justify-center text-sm">
              <a
        ...
        <footer className="border-t border-white/10 py-8 mt-10">
          <div className="mx-auto max-w-7xl px-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-slate-400">
            <div>
              © 2026 DOCUVAT. All rights reserved.
            </div>
